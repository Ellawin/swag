...
def Field(thick_super, width_reso, thick_gap, thick_reso, thick_gold, period, width_fiber, thick_sub, wavelength, angle, polarization, perm_dielec, perm_Glass, perm_Ag, perm_Au,  n_mod):
    ...
    # Eclairage par au dessus (mais pas convaincant)
    #exc[n_mod] = 1
    # eclairage par en dessous
...
### d'après réu kick-off : cube > spacing layer > film (taille du substrat) > substrat
...
thick_gold = 0 # hauteur de l'or au dessus du substrat
...
# plt.colorbar()
# plt.title("Python X dessous Lc 250")
# plt.show(block=False)
# plt.savefig("Python_X_dessous_L250.jpg") 
...
# plt.ylabel("r0")
# plt.show(block=False)
# plt.savefig("WIP_reflectance_dependanceWidthReso.jpg")
