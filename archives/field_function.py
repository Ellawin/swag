...
Mfield2 = Field(espace, Largeur_cube, Hauteur_dielec, hauteur_cube, Hauteur_gold, period, Largeur_fibre, espace2, lam, theta, pol, e_d, e_Glass, e_Ag, e_Au, n_mod)
plt.figure(2)
plt.imshow(Mfield2, cmap = 'jet', aspect = 'auto')
plt.colorbar()
plt.show(block=False)
plt.savefig("fig/field_function_2.pdf")
...
plt.colorbar()
plt.show(block=False)
plt.savefig("fig/field_function_1.pdf")
