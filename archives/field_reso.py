...
perm_metal = epsAgbb(wavelength) # argent 
n_mod = 50
n = 2 * n_mod + 1
angle = 0

Hauteur_cube = 75 # taille du résonateur selon z, en nm. Cube au départ donc H = L
hauteur_gap = 5 # taille du gap dans lequel résone le GP, dans la couche homogène de dielec. Equivalent à 'spacer'
Largeur_cube = 71.1 # pour être à la résonance, d'après la simu "function_reflectance"
#L = 250

thickness_superstrat = 200
thickness_substrat = 200 

#R = reflectance(L, H, h, wavelength, period, polarization, perm_dielec, perm_metal, n, angle)
#print("250 = ", R)

Mfield, A, thicknesses, S, Q = Field(Hauteur_cube, Largeur_cube, hauteur_gap, period, wavelength, polarization, angle, perm_dielec, perm_metal, n_mod)
...
plt.savefig("fig/field_reso.pdf")
