...
for idx_wav, wavelength in enumerate(list_wavelength):
    ...
    R_cr1[idx_wav], R_cr1d[idx_wav] = reflectance(geometry_acc1, wave, materials_Cr, n_mod)
    R_cr3[idx_wav], R_cr3d[idx_wav] = reflectance(geometry_acc3, wave, materials_Cr, n_mod)
    R_al1[idx_wav], R_al1d[idx_wav] = reflectance(geometry_acc1, wave, materials_Al, n_mod)
    R_al2[idx_wav], R_al2d[idx_wav] = reflectance(geometry_acc2, wave, materials_Al, n_mod)
    R_al3[idx_wav], R_al3d[idx_wav] = reflectance(geometry_acc3, wave, materials_Al, n_mod)
    R_ni1[idx_wav], R_ni1d[idx_wav] = reflectance(geometry_acc1, wave, materials_Ni, n_mod)
    R_ni2[idx_wav], R_ni2d[idx_wav] = reflectance(geometry_acc2, wave, materials_Ni, n_mod)
    R_ti1[idx_wav], R_ti1d[idx_wav] = reflectance(geometry_acc1, wave, materials_Ti, n_mod)
    R_ti2[idx_wav], R_ti2d[idx_wav] = reflectance(geometry_acc2, wave, materials_Ti, n_mod)
