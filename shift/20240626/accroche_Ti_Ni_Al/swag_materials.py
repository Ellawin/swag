...
perm_Ag = np.empty(list_wavelength.size, dtype = complex)
perm_Au = np.empty(list_wavelength.size, dtype = complex)
perm_TiN = np.empty(list_wavelength.size, dtype = complex)
perm_Ti = np.empty(list_wavelength.size, dtype = complex)
perm_Cr = np.empty(list_wavelength.size, dtype = complex)
perm_Al = np.empty(list_wavelength.size, dtype = complex)
perm_Ni = np.empty(list_wavelength.size, dtype = complex)

for idx_wav, wavelength in enumerate(list_wavelength):
    perm_Ag[idx_wav] = epsAgbb(wavelength) 
    perm_Au[idx_wav] = epsAubb(wavelength)
    perm_TiN[idx_wav] = nk_TiN(wavelength) ** 2
    perm_Ti[idx_wav] = nk_Tibb(wavelength) ** 2
    perm_Cr[idx_wav] = epsCrbb(wavelength)
    perm_Al[idx_wav] = epsAlbb(wavelength)
    perm_Ni[idx_wav] = epsNibb(wavelength)
    
plt.figure(1)
plt.plot(list_wavelength, np.real(perm_Ag), label = 'Ag')
plt.plot(list_wavelength, np.real(perm_Au), label = 'Au')
plt.plot(list_wavelength, np.real(perm_TiN), label = 'TiN')
#plt.plot(list_wavelength, np.real(perm_Ti), label = 'Ti')
plt.plot(list_wavelength, np.real(perm_Cr), label = 'Cr')
plt.plot(list_wavelength, np.real(perm_Al), label = 'Al')
plt.plot(list_wavelength, np.real(perm_Ni), label = 'Ni')
plt.legend()
plt.xlabel("Wavelength (nm)")
plt.ylabel("Real permittivity")
plt.title("Real permittivities")
plt.show(block=False)
plt.savefig("materials_permittivities_real.jpg")

plt.figure(2)
plt.plot(list_wavelength, np.imag(perm_Ag), label = 'Ag')
plt.plot(list_wavelength, np.imag(perm_Au), label = 'Au')
plt.plot(list_wavelength, np.imag(perm_TiN), label = 'TiN')
#plt.plot(list_wavelength, np.imag(perm_Ti), label = 'Ti')
plt.plot(list_wavelength, np.imag(perm_Cr), label = 'Cr')
plt.plot(list_wavelength, np.imag(perm_Al), label = 'Al')
plt.plot(list_wavelength, np.imag(perm_Ni), label = 'Ni')
plt.legend()
plt.xlabel("Wavelength (nm)")
plt.ylabel("Imaginary permittivity")
plt.title("Imaginary permittivities")
plt.show(block=False)
plt.savefig("materials_permittivities_imag.jpg")