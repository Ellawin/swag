...
def reflectance(geometry, wave, materials, n_mod):  
    ...
    return Rup#, Rup, Tdown, Tup#, Rup #phase_R_down#, Rup, phase_R_up#, Tdown, phase_T_down, Tup, phase_T_up
...
list_wavelength = np.linspace(400, 850, 100)
...
print("R max = ", max(R))
idx_max = np.argmax(R)
print("Resonance wavelength = ", list_wavelength[idx_max])
