...
def reflectance(thick_super, width_reso, thick_gap, thick_reso, thick_gold, period, width_fiber, thick_sub, wavelength, angle, polarization, perm_dielec, perm_Glass, perm_Ag, perm_Au,  n_mod):    
    ...
    Pdielec, Vdielec = homogene(k0, a0, polarization, 1, n)
    S = cascade(S, interface(Pc, Pdielec))
    S = c_bas(S, Vdielec, thick_gap)

    Pgold, Vgold = homogene(k0, a0, polarization, perm_Ag, n)
...
def Field(thick_super, width_reso, thick_gap, thick_reso, thick_gold, period, width_fiber, thick_sub, wavelength, angle, polarization, perm_dielec, perm_Glass, perm_Ag, perm_Au,  n_mod):
    ...
    P_3, V_3 = creneau(k0, a0, polarization, 1, 1, width_fiber, n_mod_total, position_fiber)
    A.append([P_3.tolist(), V_3.tolist()])

    # couche 4 : couche d'or au dessus de la fibre
    P_4, V_4 = creneau(k0, a0, polarization, perm_Ag, 1, width_fiber, n_mod_total, position_fiber)
...
# Cubes
width_reso = 250 # largeur du cube
...
# plt.figure(13)
# plt.plot(list_wavelength, R_gold0, "r", label="R metal 0")
# plt.plot(list_wavelength, R_gold10, "b", label="R metal 10")
# plt.plot(list_wavelength, R_gold20, "k", label="R metal 20")
# plt.plot(list_wavelength, R_gold30, "g", label="R metal 30")
# plt.plot(list_wavelength, R_gold40, "r", label="R metal 40")
# plt.plot(list_wavelength, R_gold50, "m", label="R metal 50")
# plt.plot(list_wavelength, R_gold100, "y", label = "R metal 100")
# plt.plot(list_wavelength, R_gold200, "0.7", label="R metal 200")
# plt.legend()
# plt.xlabel("Wavelength (nm) ")
# plt.ylabel("Module of reflectance")
# plt.title("Wavelength dependance, metal thickness dependance")
# plt.show(block=False)
# plt.savefig("reflectance_dependanceWavelength_ThicknessMetal.jpg")
...
# plt.colorbar()
# plt.title("Python X dessous Lc 250 fibre")
# plt.show(block=False)
# plt.savefig("Python_X_dessous_L250_fibre.jpg") 
...
# plt.show(block=False)
# plt.savefig("reflectance_dependanceWidthReso_lam750.jpg")
...
for wavelength in list_wavelength:
    perm_Ag = epsAgbb(wavelength) # argent
    perm_Au = epsAubb(wavelength)
    R_up[idx] , T_up[idx], R_down[idx], T_down[idx], phase_R_down_NR[idx], phase_R_up_NR[idx] = reflectance(thick_super, width_reso, thick_gap, thick_reso, thick_gold, period, width_fiber, thick_sub, wavelength, angle, polarization, perm_dielec, perm_Glass, perm_Ag, perm_Ag, n_mod)
    idx += 1
