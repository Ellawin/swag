...
plt.title("Cube thickness variations")
plt.xlabel("Wavelength (nm)")

plt.show(block=False)
plt.savefig("cubes_1.pdf")
plt.savefig("cubes_1.jpg")



file = open(f"Data_structures_cubes_1.txt", 'w')
file.write("Environnement : Air / n = 1 \n")
file.write("Cube : Argent / n(lambda) / 30 - 80 nm\n")
...
file.write("\n")
file.write("Wavelengths (nm) \t R_reso30_mol\t R_reso30_nomol\t R_reso40_mol\t R_reso40_nomol\t R_reso50_mol\t R_reso50_nomol\t R_reso60_mol\t R_reso70_mol\t R_reso70_nomol\t R_reso80_mol\t R_reso80_nomol\n")

for i in range(len(list_wavelength)):
    file.write(f"{list_wavelength[i]}, {R_reso30_mol[i]}\t, {R_reso30_nomol[i]}\t, {R_reso40_mol[i]}\t,{R_reso40_nomol[i]}\t,{R_reso50_mol[i]}\t,{R_reso50_nomol[i]}\t,{R_reso60_mol[i]}\t,{R_reso70_mol[i]}\t,{R_reso70_nomol[i]}\t, {R_reso80_mol[i]}\t {R_reso80_nomol[i]}\n")
file.close()
