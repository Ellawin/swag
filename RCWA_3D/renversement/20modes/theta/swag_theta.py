...
plt.show(block=False)
plt.savefig("Ngp_theta_gap3_20modes_lam600_period90_phi90_pml40_withneff.jpg")
...
plt.show(block=False)
plt.savefig("Rgp_theta_gap3_20modes_lam600_period90_phi90_pml40_withneff.jpg")
...
plt.show(block=False)
plt.savefig("RgpPhi_theta_gap3_20modes_lam600_period90_phi90_pml40_withneff.jpg")

np.savez("data_theta_gap3_20modes_lam600_phi90_period90_pml40_withneff.npz", list_theta=list_theta, r_gp = r_gp, n_gp = n_gp)
