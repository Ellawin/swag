...
for i, theta in enumerate(list_theta):
    a = -neff * k0 * np.sin(theta) * np.cos(phi)
...
plt.savefig("Ngp_theta_variable_renversed_system_gap3_5modes_lam600_period100_without_neff_phi90_pml40.jpg")
...
plt.show(block=False)
plt.savefig("Rgp_theta_variable_renversed_system_gap3_5modes_lam600_period100_without_neff_phi90_pml40.jpg")
