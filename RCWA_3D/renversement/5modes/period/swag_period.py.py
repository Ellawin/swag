...
plt.savefig("Ngp_period_gap3_5modes_lam600_phi90_pml40.jpg")
...
plt.show(block=False)
plt.savefig("Rgp_period_gap3_5modes_lam600_phi90_pml40.jpg")

np.savez("data_Ngp_period_gap3_5modes_lam600_phi90_pml40.npz", list_periodx=list_periodx, r_gp = r_gp, n_gp = n_gp)
