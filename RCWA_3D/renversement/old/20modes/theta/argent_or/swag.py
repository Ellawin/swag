...
top_gp.mu =  np.array([[1.,1., 1., 1.]])#,
                  #[1.,1.]])
top_gp.eps =  np.array([[eps_au, eps_au, eps_dielec, eps_ag]])#,
                  #[1.,1.]])
top_gp.eta=eta
top_gp.pmlx=[1, 0, 0, 0]
top_gp.pmly=[0]
...
sub_sp.eps = np.array([[eps_au, eps_au, eps_dielec, eps_dielec]])
...
plt.savefig("Ngp_theta_gap10-3_20modes_lam600_period90_phi90_pml40_KEEP.jpg")
...
plt.show(block=False)
plt.savefig("Rgp_theta_gap10-3_20modes_lam600_period90_phi90_pml40_KEEP.jpg")
...
plt.show(block=False)
plt.savefig("RgpPhi_theta_gap10-3_20modes_lam600_period90_phi90_pml40_KEEP.jpg")

np.savez("data_theta_gap10-3_20modes_lam600_phi90_period90_pml40_KEEP.npz", list_theta=list_theta, r_gp_lgap10 = r_gp_lgap10, n_gp_lgap10 = n_gp_lgap10, r_gp_lgap3 = r_gp_lgap3, n_gp_lgap3 = n_gp_lgap3)
