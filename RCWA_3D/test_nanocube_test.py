...
## geometrie du système
hcube = 40.0 # en nm
hspacer = 280.0
l_cubex = 2000.0
l_cubey = 600.0
space_x = 5001-l_cubex
space_y = 5002-l_cubey
eps_dielec = 2.2**2
# fin_pml = 500.01
# deb_cube = 100.01
...
## light
# nb_lamb = 75
#lambdas = np.linspace(7000,10000,nb_lamb+1)
...
pol = 0*np.pi/180. # 0 ou 90 pour fixer la pola
...
plt.ylabel("|r|")
plt.ylim([-0.1,1.1])
plt.savefig(f"Test_Abs_reflexion_mim_these_size{l_cubex}X{l_cubey}_theta{theta}_phi{phi}_pol{pol}_nblambd{len(lambdas)}_nbmode{Nm*Mm}_eta_{eta}.png")
# plt.clf()
