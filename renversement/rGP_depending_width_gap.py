...
def reflectance_creneau(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod):    
    ...
    return Rdown_GP, phase_R_down_GP#, np.abs(Vdown[position_GP] / k0), np.abs(GP_effective_index)
...
R_down_GP_creneau = np.empty(list_thick_gap.size)
phase_R_down_GP_creneau = np.empty(list_thick_gap.size)

idx = 0

for thick_gap in list_thick_gap:
    #perm_Ag = epsAgbb(wavelength)
    R_down_GP_creneau[idx], phase_R_down_GP_creneau[idx] = reflectance_creneau(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod)
    #R_down_GP_reseau[idx], phase_R_down_GP_reseau[idx] = reflectance_reseau(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod)
    #R_down_GP_grating[idx], phase_R_down_GP_grating[idx] = reflectance_grating(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod) 
    #R_down_GP_aper[idx], phase_R_down_GP_aper[idx] = reflectance_aper(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod) 
    idx += 1

plt.figure(4)
plt.subplot(211)
plt.plot(list_thick_gap, R_down_GP_creneau) #, "b", label="creneau")
plt.ylabel("Module")
...
plt.subplot(212)
plt.plot(list_thick_gap, phase_R_down_GP_creneau) #, "r", label="aper")
plt.plot(list_thick_gap, phase_R_down_GP_creneau) #, "b", label="grating")
plt.xlabel("Thickness gap (nm) ")
plt.ylabel("Phase")
#plt.title("Wavelength dependance")
plt.show(block=False)
plt.savefig("Phase_and_modulus_reflexion_GP_depending_thickness_gap.jpg")
...
# R_GP_grating = np.empty(list_period.size)
# phase_R_GP_grating = np.empty(list_period.size)
...
#      R_GP_grating[idx], phase_R_GP_grating[idx] = reflectance_grating(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod)
#      R_GP_aper[idx], phase_R_GP_aper[idx] = reflectance_aper(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod)
#      idx += 1

# plt.figure(6)
# plt.subplot(211)
# plt.plot(list_period, R_GP_grating, "b", label="sans PML")
# plt.plot(list_period, R_GP_aper, "r", label="avec PML 0.2")
# plt.legend()
# plt.ylabel("Module")
# plt.title("Reflectance of the GP")
# plt.show(block=False)
...
# plt.subplot(212)
# plt.plot(list_period, phase_R_GP_grating, "b", label="sans PML")
# plt.plot(list_period, phase_R_GP_aper, "r", label="avec PML 0.2")
# plt.legend()
# plt.xlabel("Period (nm) ")
# plt.ylabel("Phase")
# #plt.title("Wavelength dependance")
# plt.show(block=False)
# plt.savefig("Phase_and_modulus_reflexion_GP_depending_period_aper_comp_PML0.2.jpg")
...
# R_down_GP_creneau = np.empty(list_wavelength.size)
# phase_R_down_GP_creneau = np.empty(list_wavelength.size)

# R_down_GP_reseau = np.empty(list_wavelength.size)
# phase_R_down_GP_reseau = np.empty(list_wavelength.size)

# R_down_GP_grating = np.empty(list_wavelength.size)
# phase_R_down_GP_grating = np.empty(list_wavelength.size)

# R_down_GP_aper = np.empty(list_wavelength.size)
# phase_R_down_GP_aper = np.empty(list_wavelength.size)
...
# plt.figure(2)
# plt.subplot(211)
# #plt.plot(list_wavelength, R_down_GP_creneau, "b", label="creneau")
# plt.plot(list_wavelength, R_down_GP_aper, "r", label="aper")
# plt.plot(list_wavelength, R_down_GP_grating, "b", label="grating")
# plt.legend()
# plt.ylabel("Module")
# plt.title("Reflectance of the GP")
# plt.show(block=False)
...
# plt.subplot(212)
# plt.plot(list_wavelength, phase_R_down_GP_aper, "r", label="aper")
# plt.plot(list_wavelength, phase_R_down_GP_grating, "b", label="grating")
# plt.legend()
# plt.xlabel("Wavelength (nm) ")
# plt.ylabel("Phase")
# #plt.title("Wavelength dependance")
# plt.show(block=False)
# plt.savefig("Phase_and_modulus_reflexion_GP_depending_wavelength_comp_grating_aper.jpg")

# plt.figure(3)
# plt.plot(list_wavelength, R_down_GP_grating, "b", label="grating")
# plt.plot(list_wavelength, R_down_GP_reseau, "r", label="reseau")
# plt.ylabel("Module")
# plt.title("Reflectance of the GP")
# plt.show(block=False)
# plt.savefig("Modulus_zoom__reflexion_GP_depending_wavelength_comp_grating_reseau.jpg")
