...
def reflectance(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod):    
   ...
   # reflexion quand on eclaire par le dessus
    ...
    phase_R_up_NR = np.angle(S[position_up, position_up])
    phase_R_down_NR = np.angle(S[n + position_down, n + position_down])
...
# Mfield2 = Field(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod)
# plt.figure(1)
# plt.imshow(Mfield2, cmap = 'jet', aspect = 'auto')
# plt.colorbar()
# plt.title("Renversement")
# plt.show(block=False)
# plt.savefig("Champs_renversement.jpg") 
...
for wavelength in list_wavelength:
     ...
     R_up_NR[idx], T_up_NR[idx], R_down_NR[idx], T_down_NR[idx], phase_R_down_NR[idx], phase_R_up_NR[idx] = reflectance(thick_up, thick_down, thick_gap, thick_reso, thick_gold, period, wavelength, angle, polarization, perm_dielec, perm_Ag, n_mod)
     idx += 1
